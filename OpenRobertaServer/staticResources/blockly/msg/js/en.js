...
Blockly.Msg.ORA_EXPRBLOCK_PARSE_ERROR = "Could not parse the expression.";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR = "Errors where produced when typecheking the expression.";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_INVALID_ARGUMENT_NUMBER = "Wrong number of arguents in function call (Check help for more info on the arguments of the function).";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_INVALID_ARGUMENT_TYPE = "The expression »$« has the wrong type of argument in function call.";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_INVALID_OPERAND_TYPE = "Invalid type of operand in expression!";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_INVALID_TYPE_FOR_LIST_ELEMENT = "All elements on the list must have the same type.";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_SYNTAX_ERROR = "Syntax error in expression!";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_UNDECLARED_VARIABLE = "Variable »$« not declared";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_UNEXPECTED_METHOD = "You cannot use void methods in that expression.";
Blockly.Msg.ORA_EXPRBLOCK_TYPECHECK_ERROR_UNEXPECTED_RETURN_TYPE = "Wrong type of return value from expression!";
