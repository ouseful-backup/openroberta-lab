...
public enum Key {
    ...
    EXPRBLOCK_PARSE_ERROR,
    EXPRBLOCK_TYPECHECK_ERROR,
    EXPRBLOCK_TYPECHECK_ERROR_SYNTAX_ERROR,
    EXPRBLOCK_TYPECHECK_ERROR_INVALID_OPERAND_TYPE,
    EXPRBLOCK_TYPECHECK_ERROR_UNEXPECTED_RETURN_TYPE,
    EXPRBLOCK_TYPECHECK_ERROR_INVALID_TYPE_FOR_LIST_ELEMENT,
    EXPRBLOCK_TYPECHECK_ERROR_INVALID_ARGUMENT_NUMBER,
    EXPRBLOCK_TYPECHECK_ERROR_INVALID_ARGUMENT_TYPE,
    EXPRBLOCK_TYPECHECK_ERROR_UNDECLARED_VARIABLE,
    EXPRBLOCK_TYPECHECK_ERROR_UNEXPECTED_METHOD;
