    ...
    public void execute(Project project) {
        ...
        switch ( robotName ) {
            ...
            case "bob3":
                ...
                break;
            case "festobionic":
                builder.setFqbn("-fqbn=esp32:esp32:esp32:PSRAM=disabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none");
                break;
            default:
