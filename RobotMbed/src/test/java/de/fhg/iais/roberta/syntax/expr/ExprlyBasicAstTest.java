...
public class ExprlyBasicAstTest {
    ...
    public void colorTest() throws Exception {
        Expr<Void> e = expr2AST("#535353");
        String t = "ColorConst [#535353]";
        test(e, t, BlocklyType.COLOR);
    }
    ...
    public void connectTest() throws Exception {
        Expr<Void> e = expr2AST("connect con1, con2");
        String t = "ConnectConst [con2]";
        test(e, t, BlocklyType.CONNECTION);
    }
    ...
    public void colorListTest() throws Exception {
        Expr<Void> e = expr2AST("([#FFFFFF,#000000,getRGB(0,0,0), getRGB(255,255,255,255)])");
        String t =
            "ColorConst [#FFFFFF], ColorConst [#000000], "
    ...
    @Test
    public void connectListTest() throws Exception {
        Expr<Void> e = expr2AST("([connect con1, con2, connect con3, con4])");
        String t = "ConnectConst [con2], ConnectConst [con4]";
        test(e, t, BlocklyType.ARRAY_CONNECTION);
    }
    ...
    public void propTest() throws Exception {
        Expr<Void> e = expr2AST("[isEven(6), isOdd(9), isPrime(7), isWhole(3), isEmpty([1,2]), isPositive(4), isNegative(-2), isDivisibleBy(1,1)]");
        String t =
            "FunctionExpr [MathNumPropFunct [EVEN, [NumConst [6]]]], FunctionExpr [MathNumPropFunct [ODD, [NumConst [9]]]], FunctionExpr [MathNumPropFunct [PRIME, [NumConst [7]]]], FunctionExpr [MathNumPropFunct [WHOLE, [NumConst [3]]]], FunctionExpr [LengthOfFunct [LIST_IS_EMPTY, [ListCreate [ARRAY, NumConst [1], NumConst [2]]]]], FunctionExpr [MathNumPropFunct [POSITIVE, [NumConst [4]]]], FunctionExpr [MathNumPropFunct [NEGATIVE, [Unary [NEG, NumConst [2]]]]], FunctionExpr [MathNumPropFunct [DIVISIBLE_BY, [NumConst [1], NumConst [1]]]]";
        test(e, t, BlocklyType.ARRAY_BOOLEAN);
    }
    ...
    public void lengthTest() throws Exception {
        ...
        String t = "FunctionExpr [LengthOfFunct [LISTS_LENGTH, [ListCreate [ARRAY, NumConst [1], NumConst [2], NumConst [3]]]]]";
        test(e, t, BlocklyType.NUMBER);
    }
    ...
    public void test(Expr<Void> e, String t, BlocklyType b) throws Exception {
        ExprlyTypechecker<Void> c = new ExprlyTypechecker<Void>(e, b);
        ExprlyUnParser<Void> p = new ExprlyUnParser<Void>(e);
        c.check();
